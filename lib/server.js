...
function MQTTServer(adapter) {
    ...
    const types = {
        ...
        Total:         {type: 'number',  role: 'value.power.consumption',  read: true, write: false, unit: 'W/h'},
        Yesterday:     {type: 'number',  role: 'value.power.consumption',  read: true, write: false, unit: 'W/h'},
