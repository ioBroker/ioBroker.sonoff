...
<<<<<<< HEAD
    ...
    function setDimmer(channelId, val) {
        const stateId = 'Dimmer';
        if (clients[channelId]._map[stateId]) {
=======
	    ...
	    let channelId = parts.splice(2,parts.length).join('.');
            ...
            if (clients[channelId]) {
                ...
                if (stateId.match(/CT\d?/)) {
                    if (clients[channelId]._map && clients[channelId]._map && clients[channelId]._map[stateId]) {
                ...
                if (stateId.match(/Color\d?/)) {
                    ...
                    adapter.getObject(id, function (err, obj) {
                        if (!obj) {
							...
							adapter.setState(id,'#000000', true);
                        } else {
