    ...
    function checkData(client, topic, prefix, data, unit, path) {
        ...
        for (let attr in data) {
            ...
            if (typeof data[attr] === 'object') {
				...
				adapter.log.info('[' + client.id + '] 2. attr + types: ' + attr + ' ' + types[attr].type + ' ' + types[attr].unit);
                // create object
                const obj = addObject(attr, client, prefix, path);
                let replaceAttr = types[attr].replace || attr;
				adapter.log.info('[' + client.id + '] 5. attr + types: ' + unit + ' ' + obj.data.common.unit);
                ...
                adapter.log.info('[' + client.id + '] 5a. attr + types: ' + unit + ' ' + obj.data.common.unit);
