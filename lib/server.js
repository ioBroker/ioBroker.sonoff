...
const FLAG_TELE_SENSOR = 1;
const FLAG_TELE_STATE  = 2;
const FLAG_STAT_RESULT = 4;
        ...
        for (let attr in data) {
            ...
            if (typeof data[attr] === 'object') {
                ...
                if (autoFlags) {
                    ...
                    // auto generate objects
                    if ((parts[0] === 'tele' && (
                            (autoFlags & FLAG_TELE_SENSOR && parts[2] === 'SENSOR') || 
                            (autoFlags & FLAG_TELE_STATE  && parts[2] === 'STATE'))) || 
                        (parts[0] === 'stat' && 
                            (autoFlags & FLAG_STAT_RESULT && parts[2] === 'RESULT'))
                    ) {
                        //adapter.log.info('[' + client.id + '] auto insert object: ' + attr + ' ' + data[attr] + ' flags: ' + autoFlags);
                        //if (data[attr]) {
