    ...
    function checkData(client, topic, prefix, data, unit, path) {
        ...
        for (let attr in data) {
            ...
            if (typeof data[attr] === 'object') {
				...
				if (data[attr]) {
					adapter.log.info('[' + client.id + '] auto insert tele object: ' + attr + ' ' + data[attr]);
					...
					if (data[attr].isNaN) {
	                	...
	                	let obj = {
	                    	...
	                    	data: {
	                        	_id: id,
	                        	common: Object.assign({}, "{type:'string',role:'value',read:true,write:false}"),
	                        	native: {},
	                        	type: 'state'
	                    	}
	                	};
	                	...
	                	let obj = {
	                    	...
	                    	data: {
	                        	_id: id,
	                        	common: Object.assign({}, "{type:'number',role:'value',read:true,write:false}"),
	                        	native: {},
	                        	type: 'state'
	                    	}
	                	};
