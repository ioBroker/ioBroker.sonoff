module.exports = {
    ...
    BSSId:         {type: 'number',  role: 'state',                    read: true, write: false},
    LedTable:      {type: 'number',  role: 'state',                    read: true, write: false},
    Downtime:      {type: 'number',  role: 'state',                    read: true, write: false},
    SleepMode:     {type: 'number',  role: 'state',                    read: true, write: false},
