module.exports = {
    ...
    Button1: { type: 'object', role: 'state', read: true, write: false },
    Button2: { type: 'object', role: 'state', read: true, write: false },
    Button3: { type: 'object', role: 'state', read: true, write: false },
    Button4: { type: 'object', role: 'state', read: true, write: false },
    Button5: { type: 'object', role: 'state', read: true, write: false },
    Button6: { type: 'object', role: 'state', read: true, write: false },
    Button7: { type: 'object', role: 'state', read: true, write: false },
    Button8: { type: 'object', role: 'state', read: true, write: false },
