const datapoints: {
    ...
    BuildDateTime: { type: 'string', role: 'state', read: true, write: false },
    ...
    Core: { type: 'string', role: 'state', read: true, write: false },
    CpuFrequency: { type: 'number', role: 'value', read: true, write: false, unit: 'MHz' },
    ...
    DNSServer1: { type: 'string', role: 'state', read: true, write: false },
    DNSServer2: { type: 'string', role: 'state', read: true, write: false },
    ...
    Gateway: { type: 'string', role: 'state', read: true, write: false },
    Green: { type: 'number', role: 'level.color.green', read: true, write: true, min: 0, max: 100 },
    HTTP_API: { type: 'number', role: 'state', read: true, write: false },
    Hardware: { type: 'string', role: 'state', read: true, write: false },
    ...
    IPaddress: { type: 'string', role: 'state', read: true, write: false },
    IP6Global: { type: 'string', role: 'state', read: true, write: false },
    IP6Local: { type: 'string', role: 'state', read: true, write: false },
    ...
    Mac: { type: 'string', role: 'info.mac', read: true, write: false },
    ...
    SDK: { type: 'string', role: 'state', read: true, write: false },
    Subnetmask: { type: 'string', role: 'state', read: true, write: false },
    Scheme: {
        type: 'number',
        role: 'value',
        read: true,
    ...
    Webserver: { type: 'number', role: 'state', read: true, write: false },
    WifiConfig: { type: 'number', role: 'state', read: true, write: false },
    WifiPower: { type: 'number', role: 'value', read: true, write: false, unit: 'dBm' },
